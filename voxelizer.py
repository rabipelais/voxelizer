...
def calculate_voxels(verts, faces, width, height, depth):
    ...
    for grid_idx in range(n_blocks):
      ...
      grid.append(block_triangles(gw, gh, gd, verts, faces))
...
def intersection_triangle_voxel(vc, v0, v1, v2):
    #Assume box has size 1 on every side

    # Based on Tomas Akenine-Möller's work, for a more advanced solution, see Graphics Gems III, Triangle-Cube Intersection, pp. 236-239
